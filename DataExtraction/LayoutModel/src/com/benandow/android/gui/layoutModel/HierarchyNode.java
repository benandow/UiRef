...
public class HierarchyNode {
	...
	//TODO change to HashMap when refactoring
...
//	public HierarchyNode(String type, String name, String text, String hint, 
//						String id, int left, int top, int right, int bottom,
//						String superclass, String visibility, String counterId,
//						String inputType, String drawableId, String drawableTop, 
//						String drawableRight, String drawableBottom, String drawableLeft, 
//						String drawableVisibility, String suporPrivacyTag, String privacyTag
//				){
//		this.mType = type;
//		this.mName = name;
//		this.mText = text;
...
//		this.mDrawables = DrawableNode.parse(drawableId, drawableTop, drawableRight, 
//				drawableBottom, drawableLeft, drawableVisibility);
//		this.mSuporPrivacyTag = suporPrivacyTag;
//		this.mPrivacyTag = privacyTag;
//		this.mAssocLabel = null;
//		this.mAssocSUPORLabel = null;
//	}
